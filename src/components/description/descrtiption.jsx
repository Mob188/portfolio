...
export const Description = () => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-row mt-14 w-40 justify-around">
        <a href="https://www.linkedin.com/in/marcelo-pardo/" target="blank_">
          <svg
            className="h-7 w-7 dark:stroke-white stroke-black"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <a href="https://github.com/Mob188" target="blank_">
          <svg
            className="h-7 w-7 dark:stroke-white stroke-black"
            viewBox="0 0 24 24"
            fill="none"
